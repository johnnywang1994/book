import{_ as n,o as s,c as a,f as e}from"./app-b03d09bb.js";const p={},t=e(`<h1 id="rspack-以-rust-打造的快速構建工具" tabindex="-1"><a class="header-anchor" href="#rspack-以-rust-打造的快速構建工具" aria-hidden="true">#</a> Rspack - 以 Rust 打造的快速構建工具</h1><p>Hi 大家好，我是 Johnny，今天要介紹的是一個叫做 Rspack 的構建工具，是以 Rust 搭建的快速構建引擎</p><h2 id="特點" tabindex="-1"><a class="header-anchor" href="#特點" aria-hidden="true">#</a> 特點</h2><ul><li>快速的 Dev 啟動性能</li><li>高效的 Build 性能</li></ul><h2 id="使用-rspack" tabindex="-1"><a class="header-anchor" href="#使用-rspack" aria-hidden="true">#</a> 使用 Rspack</h2><ul><li>建立專案</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">npm</span> create rspack@latest
