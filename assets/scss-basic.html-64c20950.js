import{_ as p,r as t,o as c,c as i,a as e,d as s,e as n,f as l}from"./app-5f5a908c.js";const o={},u=s("h1",{id:"sass-scss-基礎筆記",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#sass-scss-基礎筆記","aria-hidden":"true"},"#"),n(" Sass, SCSS 基礎筆記")],-1),d=s("h6",{id:"tag-css-scss-basic",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#tag-css-scss-basic","aria-hidden":"true"},"#"),n(" tag "),s("code",null,"css"),n(", "),s("code",null,"scss"),n(", "),s("code",null,"basic")],-1),r=l(`<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><h3 id="變數定義" tabindex="-1"><a class="header-anchor" href="#變數定義" aria-hidden="true">#</a> 變數定義</h3><p>雖然 CSS 新的功能已可使用變數機制，但各瀏覽器實作的狀況不同，開發上還是稍微不穩定</p><p>且 scss 不只可使用單值變數，更可以定義 array, map 並使用</p><ul><li><p>nth($list, $index), index($list, val), length($list)</p></li><li><p>map-get($map, $key), map-keys($map), map-values($map)</p></li><li><p>append($list, $val), merge($object, $object) 來添加或覆蓋值</p></li></ul><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">*</span> <span class="token punctuation">{</span>
